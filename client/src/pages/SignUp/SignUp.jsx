  ...
  return (
    <div className='flex justify-center items-center min-h-screen'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
        ...
        <div onClick={handleGoogleSingUp} className='flex justify-center items-center space-x-2 border m-3 p-2 border-gray-300 border-rounded cursor-pointer'>
          {loading ? <FcGoogle size={32} className='animate-spin m-auto' /> : <FcGoogle size={32} />}
